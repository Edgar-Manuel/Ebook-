...
const STRATEGIES: StrategyDef[] = [
  {
    id: 'default',
    name: 'Default',
    description: 'Smart routing — calidad equilibrada en cada paso.',
    steps: {
  ...
  },
  {
    id: 'optimized',
    name: 'Optimized',
    description: 'Gran calidad a menor precio. Sonnet para escritura.',
    badge: '-60% coste',
    savePct: '60%',
    steps: {
      1: { model: 'haiku-4.5',  thinking: false, maxTokens: 2000 },
  ...
  },
  {
    id: 'budget',
    name: 'Budget',
    description: 'Haiku en la mayoría de pasos, Sonnet solo para escritura.',
    badge: '-80% coste',
    savePct: '80%',
    steps: {
      1: { model: 'haiku-4.5',  thinking: false, maxTokens: 2000 },
